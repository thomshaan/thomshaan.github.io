          ...
          <div class="container " style="padding-left: 250px;">
              ...
              <div class="member-card py-5">
                  ...
                  <div class="card-body">
                      <div class="info-row">
                          ...
                          <p><strong>Member ID:</strong> <br> <?php echo $fetchdata['member_id']?>
                              </button>
                          </p>
                      </div>
                      ...
                      <div class="info-row2">
                          ...
                          <p><strong>Loans:</strong> <br>////</p>
                      </div>

                      <div class="info-row3">
                          <p><strong>Gender :</strong> <br><?php echo $fetchdata['member_gender']?></p>
                      </div>
              ...
              <div class="biodata">
                  ...
                  <div class="biodata-body">
                      <div class="info-row">
                          <p><strong>Name :</strong> <br><?php echo $fetchdata['member_nama'] ?></p>
                          <p><strong>Gender :</strong> <br><?php echo $fetchdata['member_gender'] ?></p>
                      </div>


                      <p><strong>Email :</strong> <br><?php echo $fetchdata['member_email'] ?></p>
                      <p><strong>Address :</strong> <br><?php echo $fetchdata['member_alamat'] ?></p>
