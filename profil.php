...
<html lang="en">
  ...
  <body class="antialiased align-self-center">
    ...
    <aside>
      <div class="navbar col-sm-auto p-3 shadow">
        <div class="d-flex">
    ...
    <div class="jumbotron center py-2 ">
      <div class="container center " style="padding-left: 250px;"   >
        <h1>My Profile</h1>
        <p>Your card is verified!</p>

        <div class="member-card">
            <div class="card-header">
                <h2><b>Member Card</b></h2> 
                <img src="asset/images/LogoTAF.png" width="127">
                    
            </div>
            <div class="card-body">
                <div class="info-row">
                    <p><strong>Name:</strong> <br> Thomas Septian</p>
                    <p><strong>Member ID:</strong> <br> U6309473901 
                        <button class="copy-button" onclick="alert('Member ID copied to clipboard!')">
                            <img src="asset/icon/3square.png" alt="Copy">
                        </button>
                    </p>
                </div>
                
                <div class="info-row2">
                    <p><strong>Email:</strong> <br> thomscook@gmail.com</p>
                    <p><strong>Loans:</strong> <br> 2 of 5</p>
                </div>
                
                <div class="info-row3">
                    <p><strong>Gender :</strong> <br> Male</p>
                    <p><strong>Member Since :</strong> <br> June 2024</p>
                </div>
        ...
        <div class="biodata">
            ...
            <div class="biodata-body">
                ...
                <p><strong>Email :</strong> <br> thomscook@gmail.com</p>
                <p><strong>Address :</strong> <br> Bekasi Panas, Jl. Duren No.4B</p>
                <p><strong>Phone Number :</strong> <br> 0987654321</p>
                <p><strong>Password :</strong> <br> ************</p>
                <hr class="divider"
                <p><strong>Date Of Register :</strong> <br> June 12, 2024</p>
            </div>
