            ...
            <div class="col-sm ps-5">
                <div class="col-sm-auto" style="padding-left: 150px;">
                    <div class="container">
                                ...
                                <nav class="navbackground navbar-light">
                                    <form class="form-inline" id="search-form">
                                        <input class="form-control mr-sm-2" id="search-input" type="search"
                                            placeholder="Name/Author/ISBN" aria-label="Search">
                        ...
                        <div class="book-container col flex mb-6 py-2 ">
                            <?php
                            ...
                            if (mysqli_num_rows($select_book) > 0) {
                                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
                                    ?>
                                    <script>
                                        // Add new book cards every 1 second
                                        setInterval(() => {
                                            ...
                                            newCard.innerHTML = `
                                            <img src="images/<?php echo $fetch_book['buku_foto'] ?>" alt="Book Cover">
                                            <div class="card-body border shadow " style="padding: left 10rem;">
                                                <h5 class="card-title"><?php echo $fetch_book['buku_nama'] ?></h5>
                                                <p class="card-text"><?php echo $fetch_book['buku_pengarang'] ?></p>
                                                <a href="detailnologin.php?buku_id=<?php echo $fetch_book['buku_id'] ?>"
                                    ...
                                    while ($fetch_book = mysqli_fetch_assoc($select_book)) {
                                        ...
                                        <form method="post" action="">
                                            <div class="card btn border shadow h-100" style="padding: left 10rem;">
                                                <img class="card-img-top object-fit-center"
                                                    src="images/<?php echo $fetch_book['buku_foto'] ?>" alt="">
                                                <div class="card-body">
                                                    <h5 class="card-title"><?php echo $fetch_book['buku_nama'] ?></h5>
                                                    <p class="card-text"><?php echo $fetch_book['buku_pengarang'] ?></p>
                                                    <a href="detailnologin.php?buku_id=<?php echo $fetch_book['buku_id'] ?>"
