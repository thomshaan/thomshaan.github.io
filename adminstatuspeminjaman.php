...
if (isset($_POST['selesai'])) {
  $peminjam_id = $_POST['peminjamanid'];
  $status = "Selesai";
  $id_buku2 = $_POST['idbuku'];

  $insert_query = mysqli_query($conn, "update `dipinjam_tbl` SET peminjaman_status = '$status' where peminjaman_id = '$peminjam_id'") or die("insert query failed");
  $insert_query2 = mysqli_query($conn, "update `buku_tbl` set buku_jumlah = buku_jumlah+1 where buku_id = '$id_buku2'") or die("insert query failed");
                ...
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      ...
                      <input type="hidden" value="<?php echo $id_buku ?>" name="idbuku">
